...
{ ?>
          <ul>
            <li>
              ...
              <div class="contact_info_m"><?php   echo htmlentities("Vadodara,Gujarat"); ?></div>
            </li>
            <li>
              <div class="icon_wrap"><i class="fa fa-phone" aria-hidden="true"></i></div>
              <div class="contact_info_m"><a href="tel:61-1234-567-90"><?php   echo htmlentities("9974030259"); ?></a></div>
            </li>
            <li>
              <div class="icon_wrap"><i class="fa fa-envelope-o" aria-hidden="true"></i></div>
              <div class="contact_info_m"><a href=""><?php   echo htmlentities("project3@gmail.com"); ?></a></div>
            </li>
          </ul>
        <?php }} ?>
        </div>
